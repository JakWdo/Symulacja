...
- [ ] 101. Lazy Loading Routes - React.lazy wszystkie route components (initial <1MB, route <200ms)
- [ ] 102. N+1 Query Problem - selectinload/joinedload (API latency <300ms p90, 0 N+1 critical)
- [ ] 103. Neo4j Connection Leaks - context managers `async with` (memory stable, monitoring)
