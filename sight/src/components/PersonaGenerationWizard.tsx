...
export function PersonaGenerationWizard({ open, onOpenChange, onGenerate }: PersonaGenerationWizardProps) {
    ...
    switch (currentStep) {
      case 1:
        return (
          <div className="space-y-6">
            ...
            <div>
              <h4 className="mb-2">Demographic Presets</h4>
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="mb-4">Age Groups Distribution</h3>
      ...
      case 4:
        return (
          <div className="space-y-6">
            ...
            <div>
              <h3 className="mb-4">Required Interests</h3>
              <p className="text-sm text-muted-foreground mb-3">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] w-full lg:max-w-[1200px] h-[90vh] max-h-[90vh] bg-background border-border text-foreground flex flex-col p-0">
        <div className="p-8 pb-0">
          <DialogHeader>
            <DialogTitle>AI Persona Generation Wizard</DialogTitle>
            <DialogDescription>
        ...
        {/* Generation Progress */}
        {isGenerating && (
          <div className="px-8 py-4 space-y-2 border-t border-border">
        ...
        {/* Navigation */}
        <div className="flex flex-col sm:flex-row sm:justify-between gap-3 p-8 pt-4 border-t border-border">
          <Button
            variant="outline"
