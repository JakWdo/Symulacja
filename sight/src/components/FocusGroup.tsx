...
import { ArrowLeft, Settings as SettingsIcon, MessageSquare, BarChart3, Play, Loader2, Clock, CheckCircle, Plus, Trash2, Brain, Target } from 'lucide-react';
import logoImage from 'figma:asset/c69b7132bb4727fb2aee5acce0edc631b9d3e18f.png';
import { ScoreChart } from './ScoreChart';
import { ResultsAnalysis } from './focus-groups';
          ...
          <Card className="bg-card border border-border shadow-sm">
            ...
            <CardContent>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 space-y-4">
                    <div className="flex items-center gap-3">
                      <img 
                        src={logoImage} 
                        alt="sight logo" 
                        className="w-5 h-5 animate-spin mix-blend-multiply dark:mix-blend-screen" 
                      />
                      <span className="text-card-foreground">AI Moderator active...</span>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <Card className="bg-card border border-border">
                      ...
                      <CardContent>
                        <div className="flex flex-wrap gap-2">
                          {['easy', 'useful', 'innovative', 'complex', 'expensive', 'flexible'].map((word, idx) => (
                            <Badge 
                              key={idx} 
                              variant="outline" 
                              className="text-xs"
                              style={{
                                fontSize: `${10 + (6 - idx) * 2}px`,
                                opacity: 1 - (idx * 0.15)
                              }}
                            >
                              {word}
                    ...
                    <Card className="bg-card border border-border">
                      ...
                      <CardContent className="space-y-2">
                        <p className="text-xs text-muted-foreground mb-3">Would you use this feature?</p>
                        <div className="space-y-2">
                          <div>
                            <div className="flex justify-between text-xs mb-1">
                      ...
                      <CardContent>
                        <ul className="space-y-2 text-xs">
                          <li className="flex items-start gap-2">
                            ...
                            <span className="text-foreground">Ease of use is a priority</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-brand-orange mt-0.5">•</span>
                            <span className="text-foreground">Price sensitivity concerns</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-brand-orange mt-0.5">•</span>
                            <span className="text-foreground">Integration needs</span>
                          </li>
                        </ul>
                      </CardContent>
                    </Card>
                    ...
                    {generatingAiSummary ? (
                      <>
                        <img 
                          src={logoImage} 
                          alt="sight logo" 
                          className="w-4 h-4 mr-2 animate-spin mix-blend-multiply dark:mix-blend-screen" 
                        />
                        Generating AI Summary...
                      </>
                    ) : (
                      <>
                        <Brain className="w-4 h-4 mr-2 text-brand-orange" />
                        Generate AI Summary
                      </>
                    )}
                  </Button>
              ...
              {discussionComplete && aiSummaryGenerated && (
                <div className="text-center py-8">
                  <CheckCircle className="w-12 h-12 text-brand-orange mx-auto mb-4" />
                  <h3 className="text-lg font-medium text-brand-orange mb-2">AI Summary Generated</h3>
                  <p className="text-muted-foreground mb-4">
