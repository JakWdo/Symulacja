...
import { ArrowLeft, Settings as SettingsIcon, MessageSquare, BarChart3, Play, Loader2, Clock, CheckCircle, Plus, Trash2, Brain } from 'lucide-react';
                ...
                <CardHeader>
                  <CardTitle className="text-card-foreground flex items-center gap-2">
                    <img 
                      src={logoImage} 
                      alt="sight logo" 
                      className="w-5 h-5 mix-blend-multiply dark:mix-blend-screen" 
                    />
                    AI Summary
                  </CardTitle>
            ...
            <Card className="bg-card border border-border shadow-sm">
              <CardContent className="text-center py-12">
                <img 
                  src={logoImage} 
                  alt="sight logo" 
                  className="w-12 h-12 mx-auto mb-4 mix-blend-multiply dark:mix-blend-screen" 
                />
                <h3 className="text-lg font-medium text-card-foreground mb-2">Ready to Generate AI Summary</h3>
                <p className="text-muted-foreground mb-6">
                  The discussion is complete. Go to the Discussion tab to generate AI insights and analysis.
                </p>
                <Button 
