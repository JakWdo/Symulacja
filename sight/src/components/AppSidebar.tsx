import { Search, LayoutDashboard, FolderOpen, Settings, Command, BarChart3, MessageSquare, Users, Network } from 'lucide-react';
            ...
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton 
                  ...
                  style={currentView === 'graph-analysis' ? { borderLeftColor: '#F27405' } : {}}
                >
