...
Użycie:
    # Podgląd zmian
    python scripts/archive/backfill_segment_metadata.py --dry-run

    # Właściwy backfill
    python scripts/archive/backfill_segment_metadata.py
"""
...
# Dodaj root repo do sys.path (uruchamiamy z archive/)
...
from app.services.personas.persona_details_service import _ensure_segment_metadata  # noqa: E402
