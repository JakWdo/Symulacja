"""Polish-specific constants for RAG system and persona generation.

Stałe specyficzne dla polskiego społeczeństwa: lokalizacje, wartości,
zainteresowania, zawody, imiona, nazwiska, style komunikacji i podejmowania
decyzji, przedziały dochodowe i poziomy wykształcenia.
