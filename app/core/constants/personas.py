"""Persona attributes - occupations, values, interests, and styles.

Stałe używane przy generowaniu person: zawody, wartości życiowe,
zainteresowania, style komunikacji i podejmowania decyzji.
Używane globalnie dla różnych kontekstów kulturowych.
"""
