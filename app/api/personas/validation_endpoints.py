"""
Persona API - Validation and Background Generation

Moduł zawierający główny background worker do generacji person (_generate_personas_task).
To jest największy moduł (~760 linii) odpowiedzialny za:
- Orkiestrację generacji person (Gemini 2.5 Pro + Graph RAG)
- Równoległe wywołania LLM (Gemini 2.5 Flash)
- Walidację demograficzną i statystyczną
- Zapisywanie person do bazy danych w batch-ach
"""
