...
class RAGDocumentService:
    ...
    def __init__(self) -> None:
        ...
        # Model dla LLMGraphTransformer - bulk graph extraction (używa GRAPH_TRANSFORMER_MODEL)
        self.llm = build_chat_model(
            model=settings.GRAPH_TRANSFORMER_MODEL,
            temperature=0,
        )
            ...
            if self.graph_store:
                try:
                    ...
                    transformer = LLMGraphTransformer(
                        ...
                        additional_instructions=LLM_GRAPH_TRANSFORMER_INSTRUCTIONS,
                    )
