...
Ten moduł definiuje hardcoded workflow templates dla platformy Sight.
Każdy template zawiera predefiniowane nodes, edges i metadata.

Templates:
    - basic_research: Prosty przepływ (personas → survey → analiza)
    - deep_dive: Głęboka analiza z focus group
    - iterative_validation: Iteracja z decision points
    - brand_perception: Badanie percepcji marki
    - user_journey: Customer journey mapping
    - feature_prioritization: Feature voting + prioritization
...
class WorkflowTemplateService:
    """Serwis dla pre-built workflow templates.
    ...
    Attributes:
        TEMPLATES: Dict z wszystkimi workflow templates
    """
    ...
    TEMPLATES = {
                ...
                "nodes": [
                    ...
                    },
                    {
                        ...
                        "data": {
                            ...
                            "config": {"count": 20, "demographic_preset": "millennials", "target_audience_description": "Tech-savvy professionals"},
                        },
                    },
                    {
                        "id": "survey-1",
                        ...
                        "data": {"label": "Create Survey", "config": {"survey_title": "Product Feedback Survey", "template_id": "nps"}},
                    },
                    {
                        "id": "analysis-1",
                        "type": "analyze-results",
                        "position": {"x": 100, "y": 400},
                        "data": {"label": "Analyze Results", "config": {"analysis_type": "summary", "input_source": "survey"}},
                    },
                    {
                        "id": "end-1",
                        "type": "end",
                        "position": {"x": 100, "y": 500},
                        "data": {"label": "End", "config": {"success_message": "Research completed!"}},
                    },
                ],
                "edges": [
        ...
        "deep_dive": {
            ...
            "canvas_data": {
                "nodes": [
                    {"id": "start-1", "type": "start", "position": {"x": 100, "y": 100}, "data": {"label": "Start", "config": {"trigger_type": "manual"}}},
                    {
                        "id": "personas-1",
                        "type": "generate-personas",
                        "position": {"x": 100, "y": 200},
                        "data": {"label": "Generate Personas", "config": {"count": 20, "demographic_preset": "gen_z"}},
                    },
                    {
                        "id": "survey-1",
                        "type": "create-survey",
                        "position": {"x": 100, "y": 300},
                        "data": {"label": "Initial Survey", "config": {"survey_title": "Pre-Focus Group Survey"}},
                    },
                    {
                        "id": "focus-group-1",
                        ...
                        "data": {
                            ...
                            "config": {
                                ...
                                "topics": ["Pain points", "Feature requests", "Alternatives"],
                    ...
                    },
                    {
                        ...
                        "type": "analyze-results",
                        "position": {"x": 100, "y": 500},
                        "data": {"label": "Comprehensive Analysis", "config": {"analysis_type": "themes", "input_source": "focus_group"}},
                    },
                    {"id": "end-1", "type": "end", "position": {"x": 100, "y": 600}, "data": {"label": "End", "config": {}}},
                ],
                "edges": [
                    {"id": "e1", "source": "start-1", "target": "personas-1"},
                    {"id": "e2", "source": "personas-1", "target": "survey-1"},
        ...
        "iterative_validation": {
            ...
            "canvas_data": {
                "nodes": [
                    {"id": "start-1", "type": "start", "position": {"x": 50, "y": 50}, "data": {"label": "Start", "config": {}}},
                    {
                        "id": "personas-1",
                        "type": "generate-personas",
                        "position": {"x": 50, "y": 150},
                        "data": {"label": "Generate Initial Personas", "config": {"count": 10}},
                    },
                    {
                        "id": "focus-group-1",
                        "type": "run-focus-group",
                        "position": {"x": 50, "y": 250},
                        "data": {"label": "Focus Group", "config": {"focus_group_title": "Validation Discussion", "topics": ["Feedback", "Concerns"]}},
                    },
                    {
                        "id": "decision-1",
                        "type": "decision",
                        ...
                        "data": {
                            ...
                            "config": {"condition": "positive_percent >= 70", "true_branch_label": "Good Enough", "false_branch_label": "Need More Data"},
                        },
                    },
                    {"id": "end-1", "type": "end", "position": {"x": 200, "y": 450}, "data": {"label": "Success", "config": {}}},
                ],
                "edges": [
                    {"id": "e1", "source": "start-1", "target": "personas-1"},
                ...
                "nodes": [
                    {"id": "start-1", "type": "start", "position": {"x": 100, "y": 100}, "data": {"label": "Start", "config": {"trigger_type": "manual"}}},
                    {
                        ...
                        "data": {
                            ...
                            "config": {"count": 25, "demographic_preset": "all_ages", "target_audience_description": "Broad consumer base"},
                        },
                    },
                    {
                        "id": "survey-1",
                    ...
                    },
                    {
                        ...
                        "type": "analyze-results",
                        "position": {"x": 100, "y": 400},
                        "data": {"label": "Brand Sentiment Analysis", "config": {"analysis_type": "sentiment", "input_source": "survey"}},
                    },
                    {"id": "end-1", "type": "end", "position": {"x": 100, "y": 500}, "data": {"label": "End", "config": {"success_message": "Brand study completed!"}}},
                ],
                "edges": [
                    {"id": "e1", "source": "start-1", "target": "personas-1"},
                    {"id": "e2", "source": "personas-1", "target": "survey-1"},
            ...
            "canvas_data": {
                "nodes": [
                    {"id": "start-1", "type": "start", "position": {"x": 100, "y": 100}, "data": {"label": "Start", "config": {"trigger_type": "manual"}}},
                    {
                        ...
                        "type": "generate-personas",
                        "position": {"x": 100, "y": 200},
                        "data": {"label": "Generate User Personas", "config": {"count": 15, "demographic_preset": "users", "target_audience_description": "Active users"}},
                    },
                    {
                        "id": "focus-group-1",
                        "type": "run-focus-group",
                        ...
                        "data": {
                            ...
                            "config": {
                                ...
                                "topics": ["Onboarding experience", "Key touchpoints", "Pain points", "Moments of delight"],
                    ...
                    },
                    {
                        ...
                        "type": "analyze-results",
                        "position": {"x": 100, "y": 400},
                        "data": {"label": "Journey Analysis", "config": {"analysis_type": "journey_map", "input_source": "focus_group"}},
                    },
                    {
                        "id": "export-1",
                        "type": "export-pdf",
                        "position": {"x": 100, "y": 500},
                        "data": {"label": "Export Journey Map", "config": {"template": "journey_map", "include_quotes": True}},
                    },
                    {
                        "id": "end-1",
                        "type": "end",
                        "position": {"x": 100, "y": 600},
                        "data": {"label": "End", "config": {"success_message": "Journey map exported!"}},
                    },
                ],
                "edges": [
                    {"id": "e1", "source": "start-1", "target": "personas-1"},
            ...
            "canvas_data": {
                "nodes": [
                    {"id": "start-1", "type": "start", "position": {"x": 100, "y": 100}, "data": {"label": "Start", "config": {"trigger_type": "manual"}}},
                    {
                        ...
                        "type": "generate-personas",
                        "position": {"x": 100, "y": 200},
                        "data": {"label": "Generate User Base", "config": {"count": 30, "demographic_preset": "power_users"}},
                    },
                    {
                        "id": "survey-1",
                        "type": "create-survey",
                    ...
                    },
                    {
                        ...
                        "type": "analyze-results",
                        "position": {"x": 100, "y": 400},
                        "data": {"label": "Priority Analysis", "config": {"analysis_type": "ranking", "input_source": "survey"}},
                    },
                    {
                        "id": "decision-1",
                        "type": "decision",
                        ...
                        "data": {
                            ...
                            "config": {"condition": "rank <= 3", "true_branch_label": "Priority Features", "false_branch_label": "Backlog"},
                        },
                    },
                    {
                        "id": "end-1",
                        "type": "end",
                        "position": {"x": 100, "y": 600},
                        "data": {"label": "End", "config": {"success_message": "Top 3 features identified!"}},
                    },
                ],
                "edges": [
                    {"id": "e1", "source": "start-1", "target": "personas-1"},
    ...
    def __init__(self):
        ...
        logger.debug(f"WorkflowTemplateService initialized with {len(self.TEMPLATES)} templates")
    ...
    async def create_from_template(
        self, template_id: str, project_id: UUID, user_id: UUID, workflow_name: str | None, db: AsyncSession
    ) -> Workflow:
        ...
        workflow_data = WorkflowCreate(name=name, description=template.description, project_id=project_id, canvas_data=template.canvas_data)

        workflow = await workflow_service.create_workflow(data=workflow_data, user_id=user_id)

        logger.info(f"Created workflow '{workflow.name}' from template '{template_id}' " f"for user {user_id}")
    ...
    def validate_all_templates(self) -> dict[str, tuple[bool, list[str]]]:
        ...
        for template_id in self.TEMPLATES.keys():
            is_valid, errors = self.validate_template(template_id)
