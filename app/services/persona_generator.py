...
class PersonaGenerator:
    """Generate statistically representative personas"""
    ...
    async def generate_persona_personality(
        ...
        """Generate persona personality using LLM"""

        prompt = self._create_persona_prompt(demographic_profile, psychological_profile)
    ...
    async def _generate_with_openai(self, prompt: str) -> str:
        ...
        response = await self.openai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a market research expert creating realistic synthetic personas. Always respond with valid JSON.",
                },
