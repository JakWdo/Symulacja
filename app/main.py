...
from app.api import projects, personas, focus_groups, analysis, insights_v2
import logging
...
app.include_router(insights_v2.router, prefix=settings.API_V1_PREFIX, tags=["Enhanced Insights"])
